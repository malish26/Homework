// Задача 01: Напишите цикл, который принимает на вход два числа (A и B) 
...
// ДОПОЛНИТЕЛЬНАЯ ЗАДАЧА: Напишите программу, которая задаёт массив из 
